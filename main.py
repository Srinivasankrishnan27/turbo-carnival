...
if __name__ == "__main__":
    ...
    config_path = "F:\\codes\\turbo-carnival\\config.yaml"
    runtime_config_path = "F:\\codes\\turbo-carnival\\runtime_config.yaml"
    results = asyncio.run(run_pipeline(ground_truth, candidate, config_path, runtime_config_path))
